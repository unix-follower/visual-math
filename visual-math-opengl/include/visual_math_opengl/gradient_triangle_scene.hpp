...
enum class OpenGLSceneKind {
	GradientTriangle,
	Constellation,
};

[[nodiscard]] constexpr std::string_view opengl_scene_kind_label(OpenGLSceneKind scene_kind) {
	switch (scene_kind) {
...
[[nodiscard]] std::array<GradientTriangleVertex, 5> build_gradient_triangle_outline_vertices(
	const GradientTriangleScene& scene);
[[nodiscard]] std::array<GradientTriangleVertex, 3> build_constellation_vertices(
	const GradientTriangleScene& scene);
[[nodiscard]] std::array<GradientTriangleVertex, 4> build_constellation_indexed_vertices(
	const GradientTriangleScene& scene);
[[nodiscard]] std::array<GradientTriangleVertex, 4> build_constellation_secondary_indexed_vertices(
	const GradientTriangleScene& scene);
[[nodiscard]] std::array<GradientTriangleVertex, 5> build_constellation_outline_vertices(
	const GradientTriangleScene& scene);
